    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {stats.map((stat) => (
          <Card
            key={stat.label}
            className="overflow-hidden border-white/10 bg-white/[0.04] shadow-[0_18px_60px_rgba(0,0,0,0.2)] backdrop-blur-xl"
          >
      ...
      <div className="grid gap-6 xl:grid-cols-[1.35fr_0.65fr]">
        <Card className="overflow-hidden border-white/10 bg-white/[0.04] shadow-[0_18px_60px_rgba(0,0,0,0.2)] backdrop-blur-xl">
          <CardHeader>
            <CardTitle className="font-[family-name:var(--font-display)] text-2xl text-white">
